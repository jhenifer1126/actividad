...
<div class="content-wrapper">
    ...
    <div class="d-flex">
        <div class="card mr-6" style="width: 19rem;">
          <img src="{{asset(img/inflable.jpg)}}" class="card-img-top" alt="...">
          <div class="card-body">
            <h4 class="card-title">Nuestros Inflables</h4>
        ...
        <div class="card mr-6" style="width: 19rem;">
          <img src="{{asset(img/trampolin.jpg)}}" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Nuestro Brinca Brinca</h5>
